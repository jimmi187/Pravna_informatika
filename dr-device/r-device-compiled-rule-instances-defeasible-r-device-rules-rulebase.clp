([pen9-defeasibly-dot] of derived-attribute-rule
   (pos-name pen9-defeasibly-dot-gen235)
   (depends-on declare to_pay_max is_speeding_on_town_road_lv3_with_accident to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen9] ) ) ) ?gen210 <- ( to_pay_max ( value 60000 ) ( positive 1 ) ( positive-derivator pen9 $? ) ) ( test ( eq ( class ?gen210 ) to_pay_max ) ) ( not ( and ?gen217 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen216 & : ( >= ?gen216 1 ) ) ) ?gen210 <- ( to_pay_max ( negative ~ 2 ) ( positive-overruled $?gen212 & : ( not ( member$ pen9 $?gen212 ) ) ) ) ) ) => ?gen210 <- ( to_pay_max ( positive 0 ) )"))

([pen9-defeasibly] of derived-attribute-rule
   (pos-name pen9-defeasibly-gen237)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen9] ) ) ) ?gen217 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen216 & : ( >= ?gen216 1 ) ) ) ?gen210 <- ( to_pay_max ( value 60000 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen212 & : ( not ( member$ pen9 $?gen212 ) ) ) ) ( test ( eq ( class ?gen210 ) to_pay_max ) ) => ?gen210 <- ( to_pay_max ( positive 1 ) ( positive-derivator pen9 ?gen217 ) )"))

([pen9-overruled-dot] of derived-attribute-rule
   (pos-name pen9-overruled-dot-gen239)
   (depends-on declare to_pay_max is_speeding_on_town_road_lv3_with_accident to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen9] ) ) ) ?gen210 <- ( to_pay_max ( value 60000 ) ( negative-support $?gen213 ) ( negative-overruled $?gen214 & : ( subseq-pos ( create$ pen9-overruled $?gen213 $$$ $?gen214 ) ) ) ) ( test ( eq ( class ?gen210 ) to_pay_max ) ) ( not ( and ?gen217 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen216 & : ( >= ?gen216 1 ) ) ) ?gen210 <- ( to_pay_max ( positive-defeated $?gen212 & : ( not ( member$ pen9 $?gen212 ) ) ) ) ) ) => ( calc ( bind $?gen215 ( delete-member$ $?gen214 ( create$ pen9-overruled $?gen213 ) ) ) ) ?gen210 <- ( to_pay_max ( negative-overruled $?gen215 ) )"))

([pen9-overruled] of derived-attribute-rule
   (pos-name pen9-overruled-gen241)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen9] ) ) ) ?gen217 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen216 & : ( >= ?gen216 1 ) ) ) ?gen210 <- ( to_pay_max ( value 60000 ) ( negative-support $?gen213 ) ( negative-overruled $?gen214 & : ( not ( subseq-pos ( create$ pen9-overruled $?gen213 $$$ $?gen214 ) ) ) ) ( positive-defeated $?gen212 & : ( not ( member$ pen9 $?gen212 ) ) ) ) ( test ( eq ( class ?gen210 ) to_pay_max ) ) => ( calc ( bind $?gen215 ( create$ pen9-overruled $?gen213 $?gen214 ) ) ) ?gen210 <- ( to_pay_max ( negative-overruled $?gen215 ) )"))

([pen9-support] of derived-attribute-rule
   (pos-name pen9-support-gen243)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen9] ) ) ) ?gen209 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ) ?gen210 <- ( to_pay_max ( value 60000 ) ( positive-support $?gen212 & : ( not ( subseq-pos ( create$ pen9 ?gen209 $$$ $?gen212 ) ) ) ) ) ( test ( eq ( class ?gen210 ) to_pay_max ) ) => ( calc ( bind $?gen215 ( create$ pen9 ?gen209 $?gen212 ) ) ) ?gen210 <- ( to_pay_max ( positive-support $?gen215 ) )"))

([pen8-defeasibly-dot] of derived-attribute-rule
   (pos-name pen8-defeasibly-dot-gen245)
   (depends-on declare to_pay_min is_speeding_on_town_road_lv3_with_accident to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen8] ) ) ) ?gen201 <- ( to_pay_min ( value 40000 ) ( positive 1 ) ( positive-derivator pen8 $? ) ) ( test ( eq ( class ?gen201 ) to_pay_min ) ) ( not ( and ?gen208 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen207 & : ( >= ?gen207 1 ) ) ) ?gen201 <- ( to_pay_min ( negative ~ 2 ) ( positive-overruled $?gen203 & : ( not ( member$ pen8 $?gen203 ) ) ) ) ) ) => ?gen201 <- ( to_pay_min ( positive 0 ) )"))

([pen8-defeasibly] of derived-attribute-rule
   (pos-name pen8-defeasibly-gen247)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen8] ) ) ) ?gen208 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen207 & : ( >= ?gen207 1 ) ) ) ?gen201 <- ( to_pay_min ( value 40000 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen203 & : ( not ( member$ pen8 $?gen203 ) ) ) ) ( test ( eq ( class ?gen201 ) to_pay_min ) ) => ?gen201 <- ( to_pay_min ( positive 1 ) ( positive-derivator pen8 ?gen208 ) )"))

([pen8-overruled-dot] of derived-attribute-rule
   (pos-name pen8-overruled-dot-gen249)
   (depends-on declare to_pay_min is_speeding_on_town_road_lv3_with_accident to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen8] ) ) ) ?gen201 <- ( to_pay_min ( value 40000 ) ( negative-support $?gen204 ) ( negative-overruled $?gen205 & : ( subseq-pos ( create$ pen8-overruled $?gen204 $$$ $?gen205 ) ) ) ) ( test ( eq ( class ?gen201 ) to_pay_min ) ) ( not ( and ?gen208 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen207 & : ( >= ?gen207 1 ) ) ) ?gen201 <- ( to_pay_min ( positive-defeated $?gen203 & : ( not ( member$ pen8 $?gen203 ) ) ) ) ) ) => ( calc ( bind $?gen206 ( delete-member$ $?gen205 ( create$ pen8-overruled $?gen204 ) ) ) ) ?gen201 <- ( to_pay_min ( negative-overruled $?gen206 ) )"))

([pen8-overruled] of derived-attribute-rule
   (pos-name pen8-overruled-gen251)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen8] ) ) ) ?gen208 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen207 & : ( >= ?gen207 1 ) ) ) ?gen201 <- ( to_pay_min ( value 40000 ) ( negative-support $?gen204 ) ( negative-overruled $?gen205 & : ( not ( subseq-pos ( create$ pen8-overruled $?gen204 $$$ $?gen205 ) ) ) ) ( positive-defeated $?gen203 & : ( not ( member$ pen8 $?gen203 ) ) ) ) ( test ( eq ( class ?gen201 ) to_pay_min ) ) => ( calc ( bind $?gen206 ( create$ pen8-overruled $?gen204 $?gen205 ) ) ) ?gen201 <- ( to_pay_min ( negative-overruled $?gen206 ) )"))

([pen8-support] of derived-attribute-rule
   (pos-name pen8-support-gen253)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen8] ) ) ) ?gen200 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ) ?gen201 <- ( to_pay_min ( value 40000 ) ( positive-support $?gen203 & : ( not ( subseq-pos ( create$ pen8 ?gen200 $$$ $?gen203 ) ) ) ) ) ( test ( eq ( class ?gen201 ) to_pay_min ) ) => ( calc ( bind $?gen206 ( create$ pen8 ?gen200 $?gen203 ) ) ) ?gen201 <- ( to_pay_min ( positive-support $?gen206 ) )"))

([pen7-defeasibly-dot] of derived-attribute-rule
   (pos-name pen7-defeasibly-dot-gen255)
   (depends-on declare max_imprisonment is_speeding_on_town_road_lv3_with_accident max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen7] ) ) ) ?gen192 <- ( max_imprisonment ( value 60 ) ( positive 1 ) ( positive-derivator pen7 $? ) ) ( test ( eq ( class ?gen192 ) max_imprisonment ) ) ( not ( and ?gen199 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen198 & : ( >= ?gen198 1 ) ) ) ?gen192 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen194 & : ( not ( member$ pen7 $?gen194 ) ) ) ) ) ) => ?gen192 <- ( max_imprisonment ( positive 0 ) )"))

([pen7-defeasibly] of derived-attribute-rule
   (pos-name pen7-defeasibly-gen257)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen7] ) ) ) ?gen199 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen198 & : ( >= ?gen198 1 ) ) ) ?gen192 <- ( max_imprisonment ( value 60 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen194 & : ( not ( member$ pen7 $?gen194 ) ) ) ) ( test ( eq ( class ?gen192 ) max_imprisonment ) ) => ?gen192 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen7 ?gen199 ) )"))

([pen7-overruled-dot] of derived-attribute-rule
   (pos-name pen7-overruled-dot-gen259)
   (depends-on declare max_imprisonment is_speeding_on_town_road_lv3_with_accident max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen7] ) ) ) ?gen192 <- ( max_imprisonment ( value 60 ) ( negative-support $?gen195 ) ( negative-overruled $?gen196 & : ( subseq-pos ( create$ pen7-overruled $?gen195 $$$ $?gen196 ) ) ) ) ( test ( eq ( class ?gen192 ) max_imprisonment ) ) ( not ( and ?gen199 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen198 & : ( >= ?gen198 1 ) ) ) ?gen192 <- ( max_imprisonment ( positive-defeated $?gen194 & : ( not ( member$ pen7 $?gen194 ) ) ) ) ) ) => ( calc ( bind $?gen197 ( delete-member$ $?gen196 ( create$ pen7-overruled $?gen195 ) ) ) ) ?gen192 <- ( max_imprisonment ( negative-overruled $?gen197 ) )"))

([pen7-overruled] of derived-attribute-rule
   (pos-name pen7-overruled-gen261)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen7] ) ) ) ?gen199 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ( positive ?gen198 & : ( >= ?gen198 1 ) ) ) ?gen192 <- ( max_imprisonment ( value 60 ) ( negative-support $?gen195 ) ( negative-overruled $?gen196 & : ( not ( subseq-pos ( create$ pen7-overruled $?gen195 $$$ $?gen196 ) ) ) ) ( positive-defeated $?gen194 & : ( not ( member$ pen7 $?gen194 ) ) ) ) ( test ( eq ( class ?gen192 ) max_imprisonment ) ) => ( calc ( bind $?gen197 ( create$ pen7-overruled $?gen195 $?gen196 ) ) ) ?gen192 <- ( max_imprisonment ( negative-overruled $?gen197 ) )"))

([pen7-support] of derived-attribute-rule
   (pos-name pen7-support-gen263)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen7] ) ) ) ?gen191 <- ( is_speeding_on_town_road_lv3_with_accident ( defendant ?Defendant ) ) ?gen192 <- ( max_imprisonment ( value 60 ) ( positive-support $?gen194 & : ( not ( subseq-pos ( create$ pen7 ?gen191 $$$ $?gen194 ) ) ) ) ) ( test ( eq ( class ?gen192 ) max_imprisonment ) ) => ( calc ( bind $?gen197 ( create$ pen7 ?gen191 $?gen194 ) ) ) ?gen192 <- ( max_imprisonment ( positive-support $?gen197 ) )"))

([pen6-defeasibly-dot] of derived-attribute-rule
   (pos-name pen6-defeasibly-dot-gen265)
   (depends-on declare max_imprisonment is_speeding_on_town_road_lv3 max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen6] ) ) ) ?gen183 <- ( max_imprisonment ( value 30 ) ( positive 1 ) ( positive-derivator pen6 $? ) ) ( test ( eq ( class ?gen183 ) max_imprisonment ) ) ( not ( and ?gen190 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen189 & : ( >= ?gen189 1 ) ) ) ?gen183 <- ( max_imprisonment ( negative ~ 2 ) ( positive-overruled $?gen185 & : ( not ( member$ pen6 $?gen185 ) ) ) ) ) ) => ?gen183 <- ( max_imprisonment ( positive 0 ) )"))

([pen6-defeasibly] of derived-attribute-rule
   (pos-name pen6-defeasibly-gen267)
   (depends-on declare is_speeding_on_town_road_lv3 max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen6] ) ) ) ?gen190 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen189 & : ( >= ?gen189 1 ) ) ) ?gen183 <- ( max_imprisonment ( value 30 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen185 & : ( not ( member$ pen6 $?gen185 ) ) ) ) ( test ( eq ( class ?gen183 ) max_imprisonment ) ) => ?gen183 <- ( max_imprisonment ( positive 1 ) ( positive-derivator pen6 ?gen190 ) )"))

([pen6-overruled-dot] of derived-attribute-rule
   (pos-name pen6-overruled-dot-gen269)
   (depends-on declare max_imprisonment is_speeding_on_town_road_lv3 max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen6] ) ) ) ?gen183 <- ( max_imprisonment ( value 30 ) ( negative-support $?gen186 ) ( negative-overruled $?gen187 & : ( subseq-pos ( create$ pen6-overruled $?gen186 $$$ $?gen187 ) ) ) ) ( test ( eq ( class ?gen183 ) max_imprisonment ) ) ( not ( and ?gen190 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen189 & : ( >= ?gen189 1 ) ) ) ?gen183 <- ( max_imprisonment ( positive-defeated $?gen185 & : ( not ( member$ pen6 $?gen185 ) ) ) ) ) ) => ( calc ( bind $?gen188 ( delete-member$ $?gen187 ( create$ pen6-overruled $?gen186 ) ) ) ) ?gen183 <- ( max_imprisonment ( negative-overruled $?gen188 ) )"))

([pen6-overruled] of derived-attribute-rule
   (pos-name pen6-overruled-gen271)
   (depends-on declare is_speeding_on_town_road_lv3 max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen6] ) ) ) ?gen190 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen189 & : ( >= ?gen189 1 ) ) ) ?gen183 <- ( max_imprisonment ( value 30 ) ( negative-support $?gen186 ) ( negative-overruled $?gen187 & : ( not ( subseq-pos ( create$ pen6-overruled $?gen186 $$$ $?gen187 ) ) ) ) ( positive-defeated $?gen185 & : ( not ( member$ pen6 $?gen185 ) ) ) ) ( test ( eq ( class ?gen183 ) max_imprisonment ) ) => ( calc ( bind $?gen188 ( create$ pen6-overruled $?gen186 $?gen187 ) ) ) ?gen183 <- ( max_imprisonment ( negative-overruled $?gen188 ) )"))

([pen6-support] of derived-attribute-rule
   (pos-name pen6-support-gen273)
   (depends-on declare is_speeding_on_town_road_lv3 max_imprisonment)
   (implies max_imprisonment)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen6] ) ) ) ?gen182 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ) ?gen183 <- ( max_imprisonment ( value 30 ) ( positive-support $?gen185 & : ( not ( subseq-pos ( create$ pen6 ?gen182 $$$ $?gen185 ) ) ) ) ) ( test ( eq ( class ?gen183 ) max_imprisonment ) ) => ( calc ( bind $?gen188 ( create$ pen6 ?gen182 $?gen185 ) ) ) ?gen183 <- ( max_imprisonment ( positive-support $?gen188 ) )"))

([pen5-defeasibly-dot] of derived-attribute-rule
   (pos-name pen5-defeasibly-dot-gen275)
   (depends-on declare to_pay_max is_speeding_on_town_road_lv3 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen5] ) ) ) ?gen174 <- ( to_pay_max ( value 40000 ) ( positive 1 ) ( positive-derivator pen5 $? ) ) ( test ( eq ( class ?gen174 ) to_pay_max ) ) ( not ( and ?gen181 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen180 & : ( >= ?gen180 1 ) ) ) ?gen174 <- ( to_pay_max ( negative ~ 2 ) ( positive-overruled $?gen176 & : ( not ( member$ pen5 $?gen176 ) ) ) ) ) ) => ?gen174 <- ( to_pay_max ( positive 0 ) )"))

([pen5-defeasibly] of derived-attribute-rule
   (pos-name pen5-defeasibly-gen277)
   (depends-on declare is_speeding_on_town_road_lv3 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen5] ) ) ) ?gen181 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen180 & : ( >= ?gen180 1 ) ) ) ?gen174 <- ( to_pay_max ( value 40000 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen176 & : ( not ( member$ pen5 $?gen176 ) ) ) ) ( test ( eq ( class ?gen174 ) to_pay_max ) ) => ?gen174 <- ( to_pay_max ( positive 1 ) ( positive-derivator pen5 ?gen181 ) )"))

([pen5-overruled-dot] of derived-attribute-rule
   (pos-name pen5-overruled-dot-gen279)
   (depends-on declare to_pay_max is_speeding_on_town_road_lv3 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen5] ) ) ) ?gen174 <- ( to_pay_max ( value 40000 ) ( negative-support $?gen177 ) ( negative-overruled $?gen178 & : ( subseq-pos ( create$ pen5-overruled $?gen177 $$$ $?gen178 ) ) ) ) ( test ( eq ( class ?gen174 ) to_pay_max ) ) ( not ( and ?gen181 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen180 & : ( >= ?gen180 1 ) ) ) ?gen174 <- ( to_pay_max ( positive-defeated $?gen176 & : ( not ( member$ pen5 $?gen176 ) ) ) ) ) ) => ( calc ( bind $?gen179 ( delete-member$ $?gen178 ( create$ pen5-overruled $?gen177 ) ) ) ) ?gen174 <- ( to_pay_max ( negative-overruled $?gen179 ) )"))

([pen5-overruled] of derived-attribute-rule
   (pos-name pen5-overruled-gen281)
   (depends-on declare is_speeding_on_town_road_lv3 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen5] ) ) ) ?gen181 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen180 & : ( >= ?gen180 1 ) ) ) ?gen174 <- ( to_pay_max ( value 40000 ) ( negative-support $?gen177 ) ( negative-overruled $?gen178 & : ( not ( subseq-pos ( create$ pen5-overruled $?gen177 $$$ $?gen178 ) ) ) ) ( positive-defeated $?gen176 & : ( not ( member$ pen5 $?gen176 ) ) ) ) ( test ( eq ( class ?gen174 ) to_pay_max ) ) => ( calc ( bind $?gen179 ( create$ pen5-overruled $?gen177 $?gen178 ) ) ) ?gen174 <- ( to_pay_max ( negative-overruled $?gen179 ) )"))

([pen5-support] of derived-attribute-rule
   (pos-name pen5-support-gen283)
   (depends-on declare is_speeding_on_town_road_lv3 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen5] ) ) ) ?gen173 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ) ?gen174 <- ( to_pay_max ( value 40000 ) ( positive-support $?gen176 & : ( not ( subseq-pos ( create$ pen5 ?gen173 $$$ $?gen176 ) ) ) ) ) ( test ( eq ( class ?gen174 ) to_pay_max ) ) => ( calc ( bind $?gen179 ( create$ pen5 ?gen173 $?gen176 ) ) ) ?gen174 <- ( to_pay_max ( positive-support $?gen179 ) )"))

([pen4-defeasibly-dot] of derived-attribute-rule
   (pos-name pen4-defeasibly-dot-gen285)
   (depends-on declare to_pay_min is_speeding_on_town_road_lv3 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen4] ) ) ) ?gen165 <- ( to_pay_min ( value 20000 ) ( positive 1 ) ( positive-derivator pen4 $? ) ) ( test ( eq ( class ?gen165 ) to_pay_min ) ) ( not ( and ?gen172 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen171 & : ( >= ?gen171 1 ) ) ) ?gen165 <- ( to_pay_min ( negative ~ 2 ) ( positive-overruled $?gen167 & : ( not ( member$ pen4 $?gen167 ) ) ) ) ) ) => ?gen165 <- ( to_pay_min ( positive 0 ) )"))

([pen4-defeasibly] of derived-attribute-rule
   (pos-name pen4-defeasibly-gen287)
   (depends-on declare is_speeding_on_town_road_lv3 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen4] ) ) ) ?gen172 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen171 & : ( >= ?gen171 1 ) ) ) ?gen165 <- ( to_pay_min ( value 20000 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen167 & : ( not ( member$ pen4 $?gen167 ) ) ) ) ( test ( eq ( class ?gen165 ) to_pay_min ) ) => ?gen165 <- ( to_pay_min ( positive 1 ) ( positive-derivator pen4 ?gen172 ) )"))

([pen4-overruled-dot] of derived-attribute-rule
   (pos-name pen4-overruled-dot-gen289)
   (depends-on declare to_pay_min is_speeding_on_town_road_lv3 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen4] ) ) ) ?gen165 <- ( to_pay_min ( value 20000 ) ( negative-support $?gen168 ) ( negative-overruled $?gen169 & : ( subseq-pos ( create$ pen4-overruled $?gen168 $$$ $?gen169 ) ) ) ) ( test ( eq ( class ?gen165 ) to_pay_min ) ) ( not ( and ?gen172 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen171 & : ( >= ?gen171 1 ) ) ) ?gen165 <- ( to_pay_min ( positive-defeated $?gen167 & : ( not ( member$ pen4 $?gen167 ) ) ) ) ) ) => ( calc ( bind $?gen170 ( delete-member$ $?gen169 ( create$ pen4-overruled $?gen168 ) ) ) ) ?gen165 <- ( to_pay_min ( negative-overruled $?gen170 ) )"))

([pen4-overruled] of derived-attribute-rule
   (pos-name pen4-overruled-gen291)
   (depends-on declare is_speeding_on_town_road_lv3 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen4] ) ) ) ?gen172 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ( positive ?gen171 & : ( >= ?gen171 1 ) ) ) ?gen165 <- ( to_pay_min ( value 20000 ) ( negative-support $?gen168 ) ( negative-overruled $?gen169 & : ( not ( subseq-pos ( create$ pen4-overruled $?gen168 $$$ $?gen169 ) ) ) ) ( positive-defeated $?gen167 & : ( not ( member$ pen4 $?gen167 ) ) ) ) ( test ( eq ( class ?gen165 ) to_pay_min ) ) => ( calc ( bind $?gen170 ( create$ pen4-overruled $?gen168 $?gen169 ) ) ) ?gen165 <- ( to_pay_min ( negative-overruled $?gen170 ) )"))

([pen4-support] of derived-attribute-rule
   (pos-name pen4-support-gen293)
   (depends-on declare is_speeding_on_town_road_lv3 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen4] ) ) ) ?gen164 <- ( is_speeding_on_town_road_lv3 ( defendant ?Defendant ) ) ?gen165 <- ( to_pay_min ( value 20000 ) ( positive-support $?gen167 & : ( not ( subseq-pos ( create$ pen4 ?gen164 $$$ $?gen167 ) ) ) ) ) ( test ( eq ( class ?gen165 ) to_pay_min ) ) => ( calc ( bind $?gen170 ( create$ pen4 ?gen164 $?gen167 ) ) ) ?gen165 <- ( to_pay_min ( positive-support $?gen170 ) )"))

([pen3-defeasibly-dot] of derived-attribute-rule
   (pos-name pen3-defeasibly-dot-gen295)
   (depends-on declare to_pay_max is_speeding_on_town_road_lv2 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen3] ) ) ) ?gen156 <- ( to_pay_max ( value 20000 ) ( positive 1 ) ( positive-derivator pen3 $? ) ) ( test ( eq ( class ?gen156 ) to_pay_max ) ) ( not ( and ?gen163 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen162 & : ( >= ?gen162 1 ) ) ) ?gen156 <- ( to_pay_max ( negative ~ 2 ) ( positive-overruled $?gen158 & : ( not ( member$ pen3 $?gen158 ) ) ) ) ) ) => ?gen156 <- ( to_pay_max ( positive 0 ) )"))

([pen3-defeasibly] of derived-attribute-rule
   (pos-name pen3-defeasibly-gen297)
   (depends-on declare is_speeding_on_town_road_lv2 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen3] ) ) ) ?gen163 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen162 & : ( >= ?gen162 1 ) ) ) ?gen156 <- ( to_pay_max ( value 20000 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen158 & : ( not ( member$ pen3 $?gen158 ) ) ) ) ( test ( eq ( class ?gen156 ) to_pay_max ) ) => ?gen156 <- ( to_pay_max ( positive 1 ) ( positive-derivator pen3 ?gen163 ) )"))

([pen3-overruled-dot] of derived-attribute-rule
   (pos-name pen3-overruled-dot-gen299)
   (depends-on declare to_pay_max is_speeding_on_town_road_lv2 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen3] ) ) ) ?gen156 <- ( to_pay_max ( value 20000 ) ( negative-support $?gen159 ) ( negative-overruled $?gen160 & : ( subseq-pos ( create$ pen3-overruled $?gen159 $$$ $?gen160 ) ) ) ) ( test ( eq ( class ?gen156 ) to_pay_max ) ) ( not ( and ?gen163 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen162 & : ( >= ?gen162 1 ) ) ) ?gen156 <- ( to_pay_max ( positive-defeated $?gen158 & : ( not ( member$ pen3 $?gen158 ) ) ) ) ) ) => ( calc ( bind $?gen161 ( delete-member$ $?gen160 ( create$ pen3-overruled $?gen159 ) ) ) ) ?gen156 <- ( to_pay_max ( negative-overruled $?gen161 ) )"))

([pen3-overruled] of derived-attribute-rule
   (pos-name pen3-overruled-gen301)
   (depends-on declare is_speeding_on_town_road_lv2 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen3] ) ) ) ?gen163 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen162 & : ( >= ?gen162 1 ) ) ) ?gen156 <- ( to_pay_max ( value 20000 ) ( negative-support $?gen159 ) ( negative-overruled $?gen160 & : ( not ( subseq-pos ( create$ pen3-overruled $?gen159 $$$ $?gen160 ) ) ) ) ( positive-defeated $?gen158 & : ( not ( member$ pen3 $?gen158 ) ) ) ) ( test ( eq ( class ?gen156 ) to_pay_max ) ) => ( calc ( bind $?gen161 ( create$ pen3-overruled $?gen159 $?gen160 ) ) ) ?gen156 <- ( to_pay_max ( negative-overruled $?gen161 ) )"))

([pen3-support] of derived-attribute-rule
   (pos-name pen3-support-gen303)
   (depends-on declare is_speeding_on_town_road_lv2 to_pay_max)
   (implies to_pay_max)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen3] ) ) ) ?gen155 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ) ?gen156 <- ( to_pay_max ( value 20000 ) ( positive-support $?gen158 & : ( not ( subseq-pos ( create$ pen3 ?gen155 $$$ $?gen158 ) ) ) ) ) ( test ( eq ( class ?gen156 ) to_pay_max ) ) => ( calc ( bind $?gen161 ( create$ pen3 ?gen155 $?gen158 ) ) ) ?gen156 <- ( to_pay_max ( positive-support $?gen161 ) )"))

([pen2-defeasibly-dot] of derived-attribute-rule
   (pos-name pen2-defeasibly-dot-gen305)
   (depends-on declare to_pay_min is_speeding_on_town_road_lv2 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen2] ) ) ) ?gen147 <- ( to_pay_min ( value 10000 ) ( positive 1 ) ( positive-derivator pen2 $? ) ) ( test ( eq ( class ?gen147 ) to_pay_min ) ) ( not ( and ?gen154 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen153 & : ( >= ?gen153 1 ) ) ) ?gen147 <- ( to_pay_min ( negative ~ 2 ) ( positive-overruled $?gen149 & : ( not ( member$ pen2 $?gen149 ) ) ) ) ) ) => ?gen147 <- ( to_pay_min ( positive 0 ) )"))

([pen2-defeasibly] of derived-attribute-rule
   (pos-name pen2-defeasibly-gen307)
   (depends-on declare is_speeding_on_town_road_lv2 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen2] ) ) ) ?gen154 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen153 & : ( >= ?gen153 1 ) ) ) ?gen147 <- ( to_pay_min ( value 10000 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen149 & : ( not ( member$ pen2 $?gen149 ) ) ) ) ( test ( eq ( class ?gen147 ) to_pay_min ) ) => ?gen147 <- ( to_pay_min ( positive 1 ) ( positive-derivator pen2 ?gen154 ) )"))

([pen2-overruled-dot] of derived-attribute-rule
   (pos-name pen2-overruled-dot-gen309)
   (depends-on declare to_pay_min is_speeding_on_town_road_lv2 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen2] ) ) ) ?gen147 <- ( to_pay_min ( value 10000 ) ( negative-support $?gen150 ) ( negative-overruled $?gen151 & : ( subseq-pos ( create$ pen2-overruled $?gen150 $$$ $?gen151 ) ) ) ) ( test ( eq ( class ?gen147 ) to_pay_min ) ) ( not ( and ?gen154 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen153 & : ( >= ?gen153 1 ) ) ) ?gen147 <- ( to_pay_min ( positive-defeated $?gen149 & : ( not ( member$ pen2 $?gen149 ) ) ) ) ) ) => ( calc ( bind $?gen152 ( delete-member$ $?gen151 ( create$ pen2-overruled $?gen150 ) ) ) ) ?gen147 <- ( to_pay_min ( negative-overruled $?gen152 ) )"))

([pen2-overruled] of derived-attribute-rule
   (pos-name pen2-overruled-gen311)
   (depends-on declare is_speeding_on_town_road_lv2 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen2] ) ) ) ?gen154 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ( positive ?gen153 & : ( >= ?gen153 1 ) ) ) ?gen147 <- ( to_pay_min ( value 10000 ) ( negative-support $?gen150 ) ( negative-overruled $?gen151 & : ( not ( subseq-pos ( create$ pen2-overruled $?gen150 $$$ $?gen151 ) ) ) ) ( positive-defeated $?gen149 & : ( not ( member$ pen2 $?gen149 ) ) ) ) ( test ( eq ( class ?gen147 ) to_pay_min ) ) => ( calc ( bind $?gen152 ( create$ pen2-overruled $?gen150 $?gen151 ) ) ) ?gen147 <- ( to_pay_min ( negative-overruled $?gen152 ) )"))

([pen2-support] of derived-attribute-rule
   (pos-name pen2-support-gen313)
   (depends-on declare is_speeding_on_town_road_lv2 to_pay_min)
   (implies to_pay_min)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen2] ) ) ) ?gen146 <- ( is_speeding_on_town_road_lv2 ( defendant ?Defendant ) ) ?gen147 <- ( to_pay_min ( value 10000 ) ( positive-support $?gen149 & : ( not ( subseq-pos ( create$ pen2 ?gen146 $$$ $?gen149 ) ) ) ) ) ( test ( eq ( class ?gen147 ) to_pay_min ) ) => ( calc ( bind $?gen152 ( create$ pen2 ?gen146 $?gen149 ) ) ) ?gen147 <- ( to_pay_min ( positive-support $?gen152 ) )"))

([pen1-defeasibly-dot] of derived-attribute-rule
   (pos-name pen1-defeasibly-dot-gen315)
   (depends-on declare to_pay is_speeding_on_town_road_lv1 to_pay)
   (implies to_pay)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -1 [pen1] ) ) ) ?gen138 <- ( to_pay ( value 10000 ) ( positive 1 ) ( positive-derivator pen1 $? ) ) ( test ( eq ( class ?gen138 ) to_pay ) ) ( not ( and ?gen145 <- ( is_speeding_on_town_road_lv1 ( defendant ?Defendant ) ( positive ?gen144 & : ( >= ?gen144 1 ) ) ) ?gen138 <- ( to_pay ( negative ~ 2 ) ( positive-overruled $?gen140 & : ( not ( member$ pen1 $?gen140 ) ) ) ) ) ) => ?gen138 <- ( to_pay ( positive 0 ) )"))

([pen1-defeasibly] of derived-attribute-rule
   (pos-name pen1-defeasibly-gen317)
   (depends-on declare is_speeding_on_town_road_lv1 to_pay)
   (implies to_pay)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 1 [pen1] ) ) ) ?gen145 <- ( is_speeding_on_town_road_lv1 ( defendant ?Defendant ) ( positive ?gen144 & : ( >= ?gen144 1 ) ) ) ?gen138 <- ( to_pay ( value 10000 ) ( positive 0 ) ( negative ~ 2 ) ( positive-overruled $?gen140 & : ( not ( member$ pen1 $?gen140 ) ) ) ) ( test ( eq ( class ?gen138 ) to_pay ) ) => ?gen138 <- ( to_pay ( positive 1 ) ( positive-derivator pen1 ?gen145 ) )"))

([pen1-overruled-dot] of derived-attribute-rule
   (pos-name pen1-overruled-dot-gen319)
   (depends-on declare to_pay is_speeding_on_town_road_lv1 to_pay)
   (implies to_pay)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority -2 [pen1] ) ) ) ?gen138 <- ( to_pay ( value 10000 ) ( negative-support $?gen141 ) ( negative-overruled $?gen142 & : ( subseq-pos ( create$ pen1-overruled $?gen141 $$$ $?gen142 ) ) ) ) ( test ( eq ( class ?gen138 ) to_pay ) ) ( not ( and ?gen145 <- ( is_speeding_on_town_road_lv1 ( defendant ?Defendant ) ( positive ?gen144 & : ( >= ?gen144 1 ) ) ) ?gen138 <- ( to_pay ( positive-defeated $?gen140 & : ( not ( member$ pen1 $?gen140 ) ) ) ) ) ) => ( calc ( bind $?gen143 ( delete-member$ $?gen142 ( create$ pen1-overruled $?gen141 ) ) ) ) ?gen138 <- ( to_pay ( negative-overruled $?gen143 ) )"))

([pen1-overruled] of derived-attribute-rule
   (pos-name pen1-overruled-gen321)
   (depends-on declare is_speeding_on_town_road_lv1 to_pay)
   (implies to_pay)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 2 [pen1] ) ) ) ?gen145 <- ( is_speeding_on_town_road_lv1 ( defendant ?Defendant ) ( positive ?gen144 & : ( >= ?gen144 1 ) ) ) ?gen138 <- ( to_pay ( value 10000 ) ( negative-support $?gen141 ) ( negative-overruled $?gen142 & : ( not ( subseq-pos ( create$ pen1-overruled $?gen141 $$$ $?gen142 ) ) ) ) ( positive-defeated $?gen140 & : ( not ( member$ pen1 $?gen140 ) ) ) ) ( test ( eq ( class ?gen138 ) to_pay ) ) => ( calc ( bind $?gen143 ( create$ pen1-overruled $?gen141 $?gen142 ) ) ) ?gen138 <- ( to_pay ( negative-overruled $?gen143 ) )"))

([pen1-support] of derived-attribute-rule
   (pos-name pen1-support-gen323)
   (depends-on declare is_speeding_on_town_road_lv1 to_pay)
   (implies to_pay)
   (del-name nil)
   (derived-attribute-rule "( declare ( priority ( calc-defeasible-priority 5 [pen1] ) ) ) ?gen137 <- ( is_speeding_on_town_road_lv1 ( defendant ?Defendant ) ) ?gen138 <- ( to_pay ( value 10000 ) ( positive-support $?gen140 & : ( not ( subseq-pos ( create$ pen1 ?gen137 $$$ $?gen140 ) ) ) ) ) ( test ( eq ( class ?gen138 ) to_pay ) ) => ( calc ( bind $?gen143 ( create$ pen1 ?gen137 $?gen140 ) ) ) ?gen138 <- ( to_pay ( positive-support $?gen143 ) )"))

([rule8-defeasibly-dot] of derived-attribute-rule
   (pos-name rule8-defeasibly-dot-gen325)
...
([rule8-defeasibly] of derived-attribute-rule
   (pos-name rule8-defeasibly-gen327)
...
([rule8-overruled-dot] of derived-attribute-rule
   (pos-name rule8-overruled-dot-gen329)
   (depends-on declare is_speeding_on_town_road_lv3_with_accident lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv3_with_accident)
   (implies is_speeding_on_town_road_lv3_with_accident)
   (del-name nil)
...
([rule8-overruled] of derived-attribute-rule
   (pos-name rule8-overruled-gen331)
   (depends-on declare lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv3_with_accident)
   (implies is_speeding_on_town_road_lv3_with_accident)
   (del-name nil)
...
([rule7-defeated-dot] of derived-attribute-rule
   (pos-name rule7-defeated-dot-gen335)
...
([rule7-defeated] of derived-attribute-rule
   (pos-name rule7-defeated-gen337)
...
([rule7-defeasibly-dot] of derived-attribute-rule
   (pos-name rule7-defeasibly-dot-gen339)
...
([rule7-defeasibly] of derived-attribute-rule
   (pos-name rule7-defeasibly-gen341)
   (depends-on declare is_speeding_on_town_road_lv3 is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule7-overruled-dot] of derived-attribute-rule
   (pos-name rule7-overruled-dot-gen343)
   (depends-on declare is_speeding_on_town_road_lv1 is_speeding_on_town_road_lv3 is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule7-overruled] of derived-attribute-rule
   (pos-name rule7-overruled-gen345)
   (depends-on declare is_speeding_on_town_road_lv3 is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule6-defeated-dot] of derived-attribute-rule
   (pos-name rule6-defeated-dot-gen349)
...
([rule6-defeated] of derived-attribute-rule
   (pos-name rule6-defeated-gen351)
...
([rule6-defeasibly-dot] of derived-attribute-rule
   (pos-name rule6-defeasibly-dot-gen353)
...
([rule6-defeasibly] of derived-attribute-rule
   (pos-name rule6-defeasibly-gen355)
   (depends-on declare is_speeding_on_town_road_lv3 is_speeding_on_town_road_lv2)
   (implies is_speeding_on_town_road_lv2)
   (del-name nil)
...
([rule6-overruled-dot] of derived-attribute-rule
   (pos-name rule6-overruled-dot-gen357)
   (depends-on declare is_speeding_on_town_road_lv2 is_speeding_on_town_road_lv3 is_speeding_on_town_road_lv2)
   (implies is_speeding_on_town_road_lv2)
   (del-name nil)
...
([rule6-overruled] of derived-attribute-rule
   (pos-name rule6-overruled-gen359)
   (depends-on declare is_speeding_on_town_road_lv3 is_speeding_on_town_road_lv2)
   (implies is_speeding_on_town_road_lv2)
   (del-name nil)
...
([rule5-defeasibly-dot] of derived-attribute-rule
   (pos-name rule5-defeasibly-dot-gen363)
...
([rule5-defeasibly] of derived-attribute-rule
   (pos-name rule5-defeasibly-gen365)
...
([rule5-overruled-dot] of derived-attribute-rule
   (pos-name rule5-overruled-dot-gen367)
   (depends-on declare is_speeding_on_town_road_lv3 lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv3)
   (implies is_speeding_on_town_road_lv3)
   (del-name nil)
...
([rule5-overruled] of derived-attribute-rule
   (pos-name rule5-overruled-gen369)
   (depends-on declare lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv3)
   (implies is_speeding_on_town_road_lv3)
   (del-name nil)
...
([rule4-defeated-dot] of derived-attribute-rule
   (pos-name rule4-defeated-dot-gen373)
...
([rule4-defeated] of derived-attribute-rule
   (pos-name rule4-defeated-gen375)
...
([rule4-defeasibly-dot] of derived-attribute-rule
   (pos-name rule4-defeasibly-dot-gen377)
...
([rule4-defeasibly] of derived-attribute-rule
   (pos-name rule4-defeasibly-gen379)
   (depends-on declare is_speeding_on_town_road_lv2 is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule4-overruled-dot] of derived-attribute-rule
   (pos-name rule4-overruled-dot-gen381)
   (depends-on declare is_speeding_on_town_road_lv1 is_speeding_on_town_road_lv2 is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule4-overruled] of derived-attribute-rule
   (pos-name rule4-overruled-gen383)
   (depends-on declare is_speeding_on_town_road_lv2 is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule3-defeated-dot] of derived-attribute-rule
   (pos-name rule3-defeated-dot-gen387)
...
([rule3-defeated] of derived-attribute-rule
   (pos-name rule3-defeated-gen389)
...
([rule3-defeasibly-dot] of derived-attribute-rule
   (pos-name rule3-defeasibly-dot-gen391)
...
([rule3-defeasibly] of derived-attribute-rule
   (pos-name rule3-defeasibly-gen393)
   (depends-on declare lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv2)
   (implies is_speeding_on_town_road_lv2)
   (del-name nil)
...
([rule3-overruled-dot] of derived-attribute-rule
   (pos-name rule3-overruled-dot-gen395)
   (depends-on declare is_speeding_on_town_road_lv2 lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv2)
   (implies is_speeding_on_town_road_lv2)
   (del-name nil)
...
([rule3-overruled] of derived-attribute-rule
   (pos-name rule3-overruled-gen397)
   (depends-on declare lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv2)
   (implies is_speeding_on_town_road_lv2)
   (del-name nil)
...
([rule2-defeasibly-dot] of derived-attribute-rule
   (pos-name rule2-defeasibly-dot-gen401)
...
([rule2-defeasibly] of derived-attribute-rule
   (pos-name rule2-defeasibly-gen403)
...
([rule2-overruled-dot] of derived-attribute-rule
   (pos-name rule2-overruled-dot-gen405)
   (depends-on declare is_speeding_on_town_road_lv1 lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule2-overruled] of derived-attribute-rule
   (pos-name rule2-overruled-gen407)
   (depends-on declare lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule1-defeasibly-dot] of derived-attribute-rule
   (pos-name rule1-defeasibly-dot-gen411)
   (depends-on declare is_speeding_on_town_road_lv1 lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule1-defeasibly] of derived-attribute-rule
   (pos-name rule1-defeasibly-gen413)
   (depends-on declare lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule1-overruled-dot] of derived-attribute-rule
   (pos-name rule1-overruled-dot-gen415)
   (depends-on declare is_speeding_on_town_road_lv1 lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule1-overruled] of derived-attribute-rule
   (pos-name rule1-overruled-gen417)
   (depends-on declare lc:case lc:case lc:case lc:case is_speeding_on_town_road_lv1)
   (implies is_speeding_on_town_road_lv1)
   (del-name nil)
...
([rule3-deductive] of ntm-deductive-rule
   (pos-name rule3-deductive-gen220)
